...
#$!VarSet |MFBD| = 'C:\Users\lixx5444\Documents\plyu\acl07_clipper\'
$!VarSet |MFBD| = '/home/plyu/hosmnt/projects/acl07_clipper/'

$!VarSet |NumLoop|=12
$!Loop |NumLoop|
$!VarSet |NewNo|=(|Loop|+160)
$!VarSet |Num|=(|NewNo|*50)
...
$!ALTERDATA 
  EQUATION = '{y1}=({Y}-0.5)*6.2831853071795862/3.5/64'
$!ALTERDATA 
  EQUATION = '{Z}={/z}'
$!ALTERDATA 
  EQUATION = '{X}={x1}'
