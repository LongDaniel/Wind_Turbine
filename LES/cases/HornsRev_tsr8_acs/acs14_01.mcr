...
#$!VarSet |MFBD| = 'C:\Users\lixx5444\Documents\plyu\HornsRev\acs14_r1\'
$!VarSet |MFBD| = '/home/plyu/hosmnt/projects/HornsRev/acs14_r2/'

$!VarSet |NumLoop|=10
$!Loop |NumLoop|
$!VarSet |NewNo|=(|Loop|+10)
$!VarSet |Num|=(|NewNo|*50)
...
$!ALTERDATA 
  EQUATION = '{y1}=({Y}-0.5)*6.2831853071795862/1.00750982546/256'
$!ALTERDATA 
  EQUATION = '{Z}={/z}'
$!ALTERDATA 
  EQUATION = '{X}={x1}'
