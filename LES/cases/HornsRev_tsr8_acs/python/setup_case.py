...
fid.write(str(nturbine)+" 1 3 # NumberOfTurbines, num_foiltype, num_blade\n")
fid.write("2.0 # loc_refvel\n")
...
for i in range(nturbine):
  for j in range(nturbine):
    tmp="1.0 0.0 0.0 "+str(xij[i,j])+" "+str(yij[i,j])+" "+str(hhub_scl)+" 8.45235 14.80394 "+str(radius_scl)+" -1.02\n"
    fid.write(tmp)
