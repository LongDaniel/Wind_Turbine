...
$!VarSet |MFBD| = '/home/plyu/hosmnt/projects/clipper/acl15_clipper_3/'

$!VarSet |NumLoop|=50
$!Loop |NumLoop|
$!VarSet |NewNo|=(|Loop|+100)
$!VarSet |Num|=(|NewNo|*50)

$!VarSet |toverperiod|=(|Num|/250.0)
...
$!ALTERDATA 
  EQUATION = '{y1}=({Y}-0.5)*6.2831853071795862/1.75/64'
$!ALTERDATA 
  EQUATION = '{Z}={/z}'
$!ALTERDATA 
  EQUATION = '{X}={x1}'
...
$!SLICEATTRIBUTES 1  SHOWGROUP = NO
$!SLICEATTRIBUTES 3  SHOWGROUP = YES
$!SLICEATTRIBUTES 3  PRIMARYPOSITION{Z = 1.795}
$!SLICELAYERS SHOW = YES
$!REDRAW 
$!READDATASET  '"|MFBD|line_|Num%06d|_001_nf.dat" '
  READDATAOPTION = APPEND
