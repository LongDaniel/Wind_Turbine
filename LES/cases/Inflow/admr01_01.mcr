...
$!VarSet |MFBD| = '/home/plyu/hosmnt/projects/PorteAgel_GWS_EP_6030/admr01_3/'
#$!VarSet |MFBD| = '/home/pin/LES_HOS_Turbine/new_source_codes/note_LES/runjob/'

$!VarSet |NumLoop|=1
$!Loop |NumLoop|
$!VarSet |NewNo|=(|Loop|+21)
...
$!ALTERDATA 
  EQUATION = '{y1}=({Y}-0.5)*6.2831853071795862/8.72664625997/48'
$!ALTERDATA 
  EQUATION = '{Z}={/z}'
$!ALTERDATA 
  EQUATION = '{X}={x1}'
