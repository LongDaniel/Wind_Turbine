...
if layout==1 :
  ...
  hhub_o = 80.0/96.0 # turbine hub height
  uhub_o = 0.810874 # wind velocity at hub height (undistrubed or at rotor plane?)
  ...
  rho_air = 1.205
  nu_air = 1.511e-5 / 96.0
  
  delta_air_o = 3.0 # boundary layer height of atmosphere
  z0_air_o = 0.001 # boundary layer friction height
  kappa = 0.4 # von Karmon number
...
fid.write("0 # URefDynamicAverage\n")
...
fid.write("0 # correction3D\n")
fid.write("0 9 1 1.0 0 # InletRelaxation IR_bw IR_dataindex IR_scale IR_ti_shift\n")
...
fid.write("0 2 -2.0 3.0 0.667 # output_wake_switch, output_wake_step, wake_rel_xmin, wake_rel_xmax, wake_rel_y\n")
fid.close()
...
if layout==2:
  ...
  for ifl in range(nfoiltype):
    fname_old = '{0:s}{1:02d}{2:s}'.format('FOIL',ifl,'.orig')
    fname_new = '{0:s}{1:02d}'.format('FOIL',ifl)
    #print(fname_temp)
